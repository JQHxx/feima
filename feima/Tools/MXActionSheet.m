...
#define kButtonFontSize [UIFont regularFontWithSize:16.0f]
...
- (instancetype)initWithTitle:(NSString *)title
    ...
    if (self) {
        ...
        if (destructiveButtonTitle) {
            ...
            [destructiveButton setTitleColor:[UIColor colorWithHexString:@"#262626"] forState:UIControlStateNormal];
        ...
        if (otherButtonTitles.count) {
            ...
            for (NSString *otherButtonTitle in otherButtonTitles) {
                ...
                [otherButton setTitleColor:[UIColor colorWithHexString:@"#262626"] forState:UIControlStateNormal];
        ...
        if (cancelButtonTitle) {
            ...
            [cancelButton setTitleColor:[UIColor systemColor] forState:UIControlStateNormal];
